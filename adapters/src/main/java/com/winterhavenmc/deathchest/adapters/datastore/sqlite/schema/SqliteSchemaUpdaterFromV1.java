...
public final class SqliteSchemaUpdaterFromV1 implements SqliteSchemaUpdater
{
	...
	private void migrateChestRecords()
	{
		...
		{
			Set<ValidDeathChest> existingChests = selectAllChestRecords(connection);
...
//			ctx.plugin().getLogger().info(chestCount + " death chest records migrated to schema v2 in the SQLite datastore.");
		}
	...
	private Set<ValidDeathChest> selectAllChestRecords(final Connection connection)
	{
