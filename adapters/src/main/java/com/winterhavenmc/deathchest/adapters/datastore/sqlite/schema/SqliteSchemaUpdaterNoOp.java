...
public final class SqliteSchemaUpdaterNoOp implements SqliteSchemaUpdater
{
	...
	public SqliteSchemaUpdaterNoOp(final Plugin plugin, final MessageBuilder messageBuilder)
	{
		this.plugin = plugin;
	...
	public void update()
	{
		plugin.getLogger().info(SqliteMessage.SCHEMA_UP_TO_DATE_NOTICE.getLocalizeMessage(messageBuilder.config().locale()));
	}
