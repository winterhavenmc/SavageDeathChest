...
import com.winterhavenmc.deathchest.core.tasks.ExpireChestTask;
...
final class ChestMap
{
	 ...
	 */
	void put(final Plugin plugin, final ChestManager chestManager, final ValidDeathChest validDeathChest)
	{
		this.deathChestMap.put(validDeathChest.chestUid(), validDeathChest);
		this.expireMap.put(validDeathChest.chestUid(), createExpireTask(plugin, chestManager, validDeathChest));
	}
	...
	public int createExpireTask(final Plugin plugin, final ChestManager chestManager, final ValidDeathChest deathChest)
	{
		// create task to expire death chest after ticksRemaining
		BukkitTask chestExpireTask = new ExpireChestTask(chestManager, deathChest)
