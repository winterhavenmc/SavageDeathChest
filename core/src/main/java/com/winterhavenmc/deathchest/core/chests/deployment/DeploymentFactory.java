...
{
	public Deployment createDeployment(final ListenerCtx ctx, final Player player, final Collection<ItemStack> droppedItems)
	{
		...
		{
			return new SingleChestDeployment(ctx, player, consolidatedItems);
		}
		else
		{
			return new DoubleChestDeployment(ctx, player, consolidatedItems);
		}
	}
