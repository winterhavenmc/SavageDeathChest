...
public final class ValidDeathChest implements DeathChest
{
	...
	public int hashCode()
	{
		return Objects.hash(chestUid, ownerUid, ownerName, killerUid, killerName, worldUid, worldName, locationX, locationY, locationZ, itemCount, placementTime, expirationTime, protectionTime);
	}
